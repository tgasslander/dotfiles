...
vim.api.nvim_set_keymap('n', '<C-p>', [[<cmd>lua require('telescope.builtin').find_files({previewer = true})<CR>]], { noremap = true, silent = true })
...
require'nvim-treesitter.configs'.setup {
    ensure_installed = {"c", "rust", "typescript", "python", "go"},
    ignore_install = {""},
    sync_install = false,
    modules = {},
    auto_install = true,
...
vim.treesitter.language.register('dts', 'keymap')  -- the keymap filetype will use the devicetree parser and queries.
...
vim.cmd [[syn on]]
-- Force red highlight on whitespace
vim.api.nvim_set_hl(0, "ErrorMsg", { ctermbg=0, bg='#F44747' })
